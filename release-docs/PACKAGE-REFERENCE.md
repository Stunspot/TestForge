...
- [Plugin manifest](../releases/v1.1.7/codex/testforge/.codex-plugin/plugin.json)
- [Release manifest](../releases/v1.1.7/manifest.json)
- [Description custody](../releases/v1.1.7/description-custody.json)
- [Portable verification report](../releases/v1.1.7/verification-report.json)
- [Package receipt](../releases/v1.1.7/package-receipt.json)
