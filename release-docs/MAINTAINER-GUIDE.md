...
- [manifest.json](../releases/v2.0.0/manifest.json): exact Codex source-file hashes and Claude archive receipts.
- [verification-report.json](../releases/v2.0.0/verification-report.json): portable post-build verification.
- [description-custody.json](../releases/v2.0.0/description-custody.json): customer-facing product description custody.
- [package-receipt.json](../releases/v2.0.0/package-receipt.json): package identity and static claim boundary.
- [receipt.json](../releases/v2.0.0/receipt.json): release identity and evidence boundary.
