...
- [manifest.json](../releases/v1.1.6/manifest.json)
- [verification-report.json](../releases/v1.1.6/verification-report.json)
- [description-custody.json](../releases/v1.1.6/description-custody.json)
...
Use the checksum path in the [quick start](QUICK-START.md), record the portable verifier as unexecuted, and include that reduced-assurance state in the support bundle. Do not report static verification as passed.
