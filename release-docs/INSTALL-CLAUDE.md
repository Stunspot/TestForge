...
- [software-verification ZIP](../releases/v2.0.0/claude/software-verification-v2.0.0.zip)
- [verification-reviewer ZIP](../releases/v2.0.0/claude/verification-reviewer-v2.0.0.zip)
