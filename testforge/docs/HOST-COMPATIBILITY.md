...
TestForge v1.1.5 has two independent skills:

| Skill | Purpose | Codex unit | Claude.ai unit |
|---|---|---|---|
| `software-verification` | risk-ranked verification through evidence-backed release assessment | complete skill folder | `software-verification-v1.1.5.zip` |
| `verification-reviewer` | independent challenge of the evidence chain | complete skill folder | `verification-reviewer-v1.1.5.zip` |
