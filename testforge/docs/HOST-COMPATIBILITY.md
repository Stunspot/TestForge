...
TestForge v2.0.0 has two independent skills:

| Skill | Purpose | Codex unit | Claude.ai unit |
|---|---|---|---|
| `software-verification` | risk-ranked verification through evidence-backed release assessment | complete skill folder | `software-verification-v2.0.0.zip` |
| `verification-reviewer` | independent challenge of the evidence chain | complete skill folder | `verification-reviewer-v2.0.0.zip` |
